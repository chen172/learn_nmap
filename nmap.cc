...
////这个函数填充NmapOps结构和scan_lists结构	
...
#endif
	//o.ping_group_sz is 4096
	//o.minHostGroupSz() is 1
  ...
  do {
	...
	//ideal_scan_group_sz is 64
	printf("size is %d\n", ideal_scan_group_sz);
	//Targets.size() is 0
	printf("Targets.size() is %d\n", Targets.size());
	// begin while 
	//添加目标
